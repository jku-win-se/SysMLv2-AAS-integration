 ...
 *   <li>{@link AAS.impl.ReferableImpl#getExtension <em>Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ReferableImpl extends MinimalEObjectImpl.Container implements Referable {
	...
	public EList<Extension> getExtension() {
		if (extension == null) {
			extension = new EObjectContainmentEList<Extension>(Extension.class, this, AASPackage.REFERABLE__EXTENSION);
		}
		return extension;
	}
