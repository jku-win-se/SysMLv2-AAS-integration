...
public class AASPackageImpl extends EPackageImpl implements AASPackage {
	 ...
	 */
	@Override
	public EReference getReferable_Extension() {
	...
	public void createPackageContents() {
		...
		createEReference(referableEClass, REFERABLE__EXTENSION);
	...
	public void initializePackageContents() {
		...
		initEReference(getReferable_Extension(), this.getExtension(), null, "extension", null, 0, -1, Referable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
