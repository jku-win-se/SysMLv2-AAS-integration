...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.MetadataDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetadataDefinitionItemProvider extends ItemDefinitionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MetadataDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((MetadataDefinition)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MetadataDefinition_type") :
			getString("_UI_MetadataDefinition_type") + " " + label;
	}
