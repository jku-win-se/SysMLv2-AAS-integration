...
public class SendActionUsageItemProvider extends ActionUsageItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSenderArgumentPropertyDescriptor(object);
		}
	...
	protected void addPayloadArgumentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SendActionUsage_payloadArgument_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SendActionUsage_payloadArgument_feature", "_UI_SendActionUsage_type"),
				 SysMLPackage.Literals.SEND_ACTION_USAGE__PAYLOAD_ARGUMENT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Sender Argument feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSenderArgumentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SendActionUsage_senderArgument_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SendActionUsage_senderArgument_feature", "_UI_SendActionUsage_type"),
