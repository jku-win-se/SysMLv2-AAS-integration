...
public class FlowConnectionUsageItemProvider extends ConnectionUsageItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFlowConnectionDefinitionPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.ITEM_FLOW__INTERACTION,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Flow Connection Definition feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFlowConnectionDefinitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FlowConnectionUsage_flowConnectionDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FlowConnectionUsage_flowConnectionDefinition_feature", "_UI_FlowConnectionUsage_type"),
				 SysMLPackage.Literals.FLOW_CONNECTION_USAGE__FLOW_CONNECTION_DEFINITION,
				 true,
				 false,
				 true,
				 null,
