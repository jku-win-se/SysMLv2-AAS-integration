...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.MetadataAccessExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetadataAccessExpressionItemProvider extends ExpressionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MetadataAccessExpressionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MetadataAccessExpression_referencedElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MetadataAccessExpression_referencedElement_feature", "_UI_MetadataAccessExpression_type"),
	...
	/**
	 * This returns MetadataAccessExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MetadataAccessExpression"));
	}
	...
	public String getText(Object object) {
		String label = ((MetadataAccessExpression)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MetadataAccessExpression_type") :
			getString("_UI_MetadataAccessExpression_type") + " " + label;
	}
