	...
	protected void addLoopVariablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForLoopActionUsage_loopVariable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForLoopActionUsage_loopVariable_feature", "_UI_ForLoopActionUsage_type"),
				 SysMLPackage.Literals.FOR_LOOP_ACTION_USAGE__LOOP_VARIABLE,
				 true,
				 false,
				 true,
				 null,
