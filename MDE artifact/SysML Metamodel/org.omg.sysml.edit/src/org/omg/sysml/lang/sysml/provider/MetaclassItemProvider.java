...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.Metaclass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetaclassItemProvider extends StructureItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MetaclassItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Metaclass"));
	}
	...
	public String getText(Object object) {
		String label = ((Metaclass)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Metaclass_type") :
			getString("_UI_Metaclass_type") + " " + label;
	}
