...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.SelectExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SelectExpressionItemProvider extends OperatorExpressionItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((SelectExpression)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SelectExpression_type") :
			getString("_UI_SelectExpression_type") + " " + label;
	}
