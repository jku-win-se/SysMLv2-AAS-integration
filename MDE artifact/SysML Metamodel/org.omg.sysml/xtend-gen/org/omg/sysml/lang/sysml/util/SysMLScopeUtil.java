...
public class SysMLScopeUtil {
  ...
  public static Element getElementFor(final EObject context, final EReference reference, final String name) {
    return SysMLScopeUtil.getScopeFor(context.eResource(), context, reference).getElement(name);
  }
}
