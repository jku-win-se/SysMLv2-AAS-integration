...
public class SysMLLibraryUtil {
  ...
  private static String modelLibraryPath = SysMLLibraryUtil.DEFAULT_MODEL_LIBRARY_PATH;

  public static String setModelLibraryDirectory(final String dir) {
    String _xblockexpression = null;
    {
      final URI uri = URI.createFileURI(dir);
      String _elvis = null;
      ...
      _xblockexpression = SysMLLibraryUtil.modelLibraryPath = _elvis;
    }
    return _xblockexpression;
  }

  public static String getModelLibraryPath() {
    return SysMLLibraryUtil.modelLibraryPath;
  }
